...
import com.leandrooliveira.cursomc.domain.ItemPedido;
import com.leandrooliveira.cursomc.domain.Pagamento;
import com.leandrooliveira.cursomc.domain.PagamentoComBoleto;
import com.leandrooliveira.cursomc.domain.PagamentoComCartao;
import com.leandrooliveira.cursomc.domain.Pedido;
...
import com.leandrooliveira.cursomc.repositories.EstadoRepository;
import com.leandrooliveira.cursomc.repositories.ItemPedidoRepository;
import com.leandrooliveira.cursomc.repositories.PagamentoRepository;
import com.leandrooliveira.cursomc.repositories.PedidoRepository;
import com.leandrooliveira.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93898393"));
		
		Cliente cli2 = new Cliente(null, "Ana costa", "ana.costa@gmail.com", "24176470445", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27363396", "93898354"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua  Flores", "300", "Apto 303", "Jardim", "3822834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38777015", cli1, c2);
